...
.pageContent .pageLabel .size{
    ...
    width: 0.00mm;
    height: 0.00mm;
    border-top: 2.91mm solid #999;
    border-bottom: 2.91mm solid #999;
    border-left: 11.11mm solid #999;
    border-right: 11.11mm solid #999;
}
...
.hgc_print .opratorArea .layoutItem .icon_current:before{
    ...
    width: 1.85mm;
    height: 1.32mm;
    border-bottom:0.26mm solid green;
    border-left:0.26mm solid green;
    top: 50%;
    left: 50%;
    -webkit-transform: translate(-50%,-50%) rotate(-45deg);
            transform: translate(-50%,-50%) rotate(-45deg);
...
.hgc_print .opratorArea .subjectList li{
    ...
    -webkit-box-align: center;
        -ms-flex-align: center;
            align-items: center;
    line-height: 10.58mm;
    border-bottom:0.26mm dashed #ddd;
    font-size:3.17mm;
}
